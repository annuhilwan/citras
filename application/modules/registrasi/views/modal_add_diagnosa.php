  ...
  <div class="box-body">
    <div class="row">
						...
						<div class="form-group has-feedback">
								...
								<input  type="text" name="jenis_resume" id="jenis_resume" value="DIAGNOSA" class="form-control" readonly>
							</div>
						  ...
						  <div class="form-group">
						    ...
						    <input  type="text" name="hasil_resume" id="hasil_resume" value="" class="form-control" placeholder="Hasil Pemeriksaan">
						  </div>
						</div>
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    return false;
		...
		$( "#hasil_resume" ).autocomplete({
			source: "<?php echo site_url('registrasi/get_autocomplete_add_model_diagnosa');?>",
