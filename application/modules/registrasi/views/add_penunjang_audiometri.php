  ...
  <div class="box-body">
    <div class="row">
						  ...
						  <div class="form-group">
						    ...
						    <input  type="text" name="nama_dokter" id="nama_dokter" value="<?php echo isset($data['dokter_pemeriksa'])?$data['dokter_pemeriksa']:$data['nama_dokter_audiometri'];?>" class="form-control" placeholder="Dokter Pemeriksa">
						  </div>
						</div>
						...
						<div class="form-group has-feedback">
								<label for="exampleInputstatus">Jenis Pemeriksaan :</label>
								 <input  type="text" name="jenis_pemeriksaan" id="jenis_pemeriksaan" value="AUDIOMETRI" class="form-control" readonly>
