  ...
  <div class="box-body">
    <div class="row">
						...
						<div class="form-group has-feedback">
								...
								<input  type="text" name="nama_pemeriksaan" id="nama_pemeriksaan" value="COR(JANTUNG)" class="form-control" readonly>
							</div>
						  ...
						  <div class="form-group">
						    ...
						    <input  type="text" name="hasil_pemeriksaan" id="hasil_pemeriksaan" value="CTR < 0,5" class="form-control" placeholder="Hasil Pemeriksaan">
						  </div>
						</div>
