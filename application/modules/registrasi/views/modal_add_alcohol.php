  ...
  <div class="box-body">
    <div class="row">
						...
						<div class="form-group has-feedback">
								...
								<input  type="text" name="jenis_pemeriksaan" id="jenis_pemeriksaan" value="ALCOHOL BREATH TEST" class="form-control" readonly>
							</div>
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    return false;
		...
		$( "#hasil_resume" ).autocomplete({
			source: "<?php echo site_url('registrasi/get_autocomplete_add_model_alcohol');?>",
