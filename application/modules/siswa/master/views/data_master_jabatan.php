      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Master Jabatan</h3>
            <div class="box-tools">
              <?php if(CheckPermission("users", "own_create")){ ?>
              <button type="button" class="btn-sm  btn btn-success modalButtonJabatan" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Add Jabatan</button>
...
<script type="text/javascript">
  $(document).ready(function() {  
    ...
    var table = $('#example1').DataTable({ 
          ...
          "processing": true,
          "serverSide": true,
          "ajax": url+"master/data_master_jabatan",
