				...
				<div class="x_content">
					<div class role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
							<li role="presentation" class="active"><a href="#tab_content1" id="spj-tab" role="tab" data-toggle="tab" aria-expanded="true">Summary Tagihan</a></li>				
    ...
    <div class="box box-primary popup" >
      ...
      <div class="modal-body" style="padding: 0px 0px 0px 0px;"></div>
					...
					<div class="form-group has-feedback">
						<button class="btn btn-success" onclick=" window.open('<?php echo base_url().'kasir/printDetailPembayaranKasir/'.$arrDataPasien['id'] ?>','_blank')"> Cetak</button>	
