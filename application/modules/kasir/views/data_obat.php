        ...
        <div class="box box-success">
          <div class="box-header with-border">
            ...
            <div class="box-tools">
              ...
              <button type="button" class="btn-sm  btn btn-success modalButtonObat" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Add Obat</button>
