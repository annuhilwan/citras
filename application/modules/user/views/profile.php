        ...
        <div class="box-body box-profile">
          ...
          <div class="col-md-8">
            ...
            <div class="form-group has-feedback">
              ...
              <span class="glyphicon glyphicon-lock form-control-feedback" style="pointer-events: initial;" onclick="showPassLast()"></span>
            </div>                       
            <div class="form-group has-feedback">
              <label for="exampleInputEmail1">New Password:</label>
              <input type="password" class="form-control" placeholder="New Password" name="password">
              <span class="glyphicon glyphicon-pencil form-control-feedback" style="pointer-events: initial;" onclick="showPassNew()"></span>
            </div>                       
            <div class="form-group has-feedback">
              <label for="exampleInputEmail1">Confirm New Password:</label>
              <input type="password" class="form-control" placeholder="Confirm New Password" name="confirmPassword">
              <span class="glyphicon glyphicon-pencil form-control-feedback" style="pointer-events: initial;" onclick="showPassConfirm()"></span>
            </div>  
            <br>
...
<!-- /.content-wrapper -->
<script>
     function showPassLast() {
         var passType = $("input[name='currentpassword']").attr('type');
         if (passType === 'password') {
             $("input[name='currentpassword']")[0].type = 'text';
         } else {
            $("input[name='currentpassword']")[0].type = 'password';
         }
     }
     ...
     function showPassConfirm() {
         var passType = $("input[name='confirmPassword']").attr('type');
         if (passType === 'password') {
             $("input[name='confirmPassword']")[0].type = 'text';
         } else {
            $("input[name='confirmPassword']")[0].type = 'password';
         }
     }
 </script>