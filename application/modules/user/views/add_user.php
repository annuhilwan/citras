<form role="form bor-rad" enctype="multipart/form-data" action="<?php echo base_url().'user/add_edit'?>" method="post">
  <div class="box-body">
    <div class="row">
        ...
        <div class="col-md-6">
          <button type="button" onclick="location.href='<?php echo base_url();?>user/generateresetPassword/<?php echo $userData->users_id; ?>'" class="btn btn-success wdt-bg">Reset Password</button>
        </div>
        </div>
        <div class="row" style="margin-top:7px;">
            <div class="col-md-6"></div>
            <div class="col-md-6">
              <button type="button" onclick="location.href='<?php echo base_url();?>user/generateresetPasswordBasic/<?php echo $userData->users_id; ?>'" class="btn btn-success wdt-bg">Reset Password Basic</button>
            </div>
        </div>
              <!-- /.box-body -->
        <?php }else{?>
