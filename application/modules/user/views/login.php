...
<html>
  <head>
    ...
    <title>Citra Ardhita Medifarma | Log in</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url().'user/auth_user'; ?>" method="post">
          ...
          <div class="form-group has-feedback">
            ...
            <span class="glyphicon glyphicon-lock form-control-feedback" style="pointer-events: initial;" onclick="showPass()"></span>
          </div>
          <div class="row">
            <!-- <div class="col-xs-8">
      ...
      <!-- /.login-box-body -->
      <?php
        //  echo show_err_msg($this->session->flashdata('messagePr'));
      ?>
    </div>
