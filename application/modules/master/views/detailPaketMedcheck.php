				...
				<div class="x_content">
					...
					<div id="myTabContent" class="tab-content">
						...
						<br/>
							...
							<button type="button" class="btn-sm  btn btn-success modalButtonTipePemeriksaanCheck" data-src="<?php echo $arrDataPaket['id']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Add Label</button>
